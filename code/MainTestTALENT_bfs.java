...
/**
 * This file shows how to run the bfs version of TALENT algorithm on an input file.
 * 
 * @author Zefeng Chen
 * @see AlgoTALENT_bfs
 */
public class MainTestTALENT_bfs {
	public static void main(String[] args) throws IOException {
		...
		AlgoTALENT_bfs nosep_i = new AlgoTALENT_bfs();
		...
		AlgoTALENT_bfs.IInt Query = nosep_i.new IInt(l1,l1.size());
	...
	public static String fileToPath(String filename) throws UnsupportedEncodingException {
		URL url = MainTestTALENT_bfs.class.getResource(filename);
